...
{
	centralizer::spawnSpectator(getcvar("g_gametype"), origin, angles);
}
...
{
	centralizer::killcam(getcvar("g_gametype"), attackerNum, delay);
}

roundcam(delay,winningteam)
{
	centralizer::roundcam(getcvar("g_gametype"), delay, winningteam);
}
